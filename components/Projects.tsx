...
export default function Projects() {
  ...
  return (
    <section id="projects" className="min-h-screen overflow-hidden w-full relative z-10">
      <div className="h-[30vh] flex flex-col items-center justify-center space-y-4 pt-16 shrink-0 relative z-20">
        <motion.div
          ref={ref}
        ...
        >
          ...
          <h2
            className="text-4xl md:text-5xl font-normal tracking-tighter uppercase text-[#111111]"
          >
            Portfolios
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          className="animate-bounce text-[#888888] text-xs font-medium uppercase mt-8"
        >
          ( Scroll ↓ )
        </motion.div>
      </div>
